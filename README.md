...
<h4>
  함께 일하는 동료들과 소통 및 협업을 통한 개발을 좋아합니다. 
  <br/> 
  몇 줄의 코드를 통해서 원하는 것을 만드는 것에 대단히 흥미가 있는 편입니다.<br/>
  단순히 코드를 쓰는 것보다 꾸준히 학습하는 것을 좋아합니다. <br/>
  그래서 블로그에 항상 TIl,WIL,에러노트 등을 200여개 이상의 게시글을 매일 꾸준하게 작성하면서 학습하고 있습니다.<br/>
  </h4>
